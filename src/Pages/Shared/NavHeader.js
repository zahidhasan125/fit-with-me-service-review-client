                ...
                <Container fluid>
                    <Link to="/" className='text-decoration-none'>
                        <Navbar.Brand style={{ position: 'relative' }}>
                            <img src={logo} alt="" style={{ width: "80px", position: "absolute", top: "-25px", left: "20px" }} />
                            FIT WITH ME
                        </Navbar.Brand>
                    </Link>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        ...
                        >
                            <Link to="/">
                                <button type="button" className="btn btn-light rounded-pill fw-bold">
                                    Home
                                </button>
                            </Link>
                            <Link to="/allservices">
                        ...
                        <Link to="/allservices" className="d-flex text-decoration-none">
